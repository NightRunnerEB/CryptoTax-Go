...
const (
	EventAcquisition DatasetEventType = "acquisition"
	EventDisposition DatasetEventType = "disposition"
	EventIncome      DatasetEventType = "income"
	EventExpense     DatasetEventType = "expense"
	EventTransfer    DatasetEventType = "transfer"
	EventLoss        DatasetEventType = "loss"
	EventGiftIn      DatasetEventType = "gift_in"
	EventGiftOut     DatasetEventType = "gift_out"
)

type DatasetEvent struct {
	EventType     DatasetEventType  `json:"event_type"`
